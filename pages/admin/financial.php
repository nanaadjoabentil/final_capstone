...
<br>
  ...
  <form method="post" id="form">
    ...
    {
      header("location: viewStudentFinancial.php");
    }
    else if (isset($_POST['delete']))
    {
      header("location: deleteFinancial.php");
    }
    else if (isset($_POST['add']))
    {
      header("location: addStudentFinancial.php");
    }
    else
    {
      echo '<h3> All Financial Information </h3>'.'<br>';
      viewAllFinancial();
    }
    ?>
  </form>
